...
public class AudioLineAdapter extends BaseMediaLineAdapter {

    public AudioLineAdapter(HorizontalScrollView horizontalScrollView, RelativeLayout mediaLineContainer, List<MediaFile> mediaFiles, ProjectInfo projectInfo, Context context, AppCompatActivity activity) {
    ...
    protected BaseCustomLineLayout AddItemMedia(int index, MediaFile mediaFile, Boolean isFirst, Boolean isEnd, BaseCustomLineLayout previous) {
        CustomAudioLineLayout customLineLayout = new CustomAudioLineLayout(mediaLineContainer.getContext(), null);
    ...
    public void onTimeSet() {
        this.mediaFiles = projectInfo.getAudioFiles();
        populateMediaItems();
    }
}